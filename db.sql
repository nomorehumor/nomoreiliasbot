...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `docs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `docs` (
  ...
  `linkedUser` varchar(255) DEFAULT NULL,
...
INSERT INTO `docs` VALUES (1,'sadcsad','sdacsd','dcasd');
...
INSERT INTO `links` VALUES (1,'','',''),(2,'sadc','sdc','asd');
...
-- Dump completed on 2020-02-17 21:37:44
